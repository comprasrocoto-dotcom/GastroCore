      ...
      {open ? (
        ...
        >
          <span className="truncate">
            {seleccionado ? tipoIcono(seleccionado.tipo_item) + ' ' + seleccionado.articulo : 'Selecciona ingrediente...'}
          </span>
                ...
                return (
                  ...
                  >
                    <div className="min-w-0">
                      <div className="flex items-center gap-1.5 truncate text-sm font-medium text-salvia-900">
                        <span className={ins.tipo_item === 'subreceta' ? 'shrink-0 rounded bg-[#EEF2FF] px-1 text-[10px] font-semibold text-[#4338CA]' : 'shrink-0 rounded bg-[#F0FDF4] px-1 text-[10px] font-semibold text-[#15803D]'}>
                          {ins.tipo_item === 'subreceta' ? '\uD83E\uDD63 SUB' : '\uD83D\uDCE6 INS'}
                        </span>
                        <span className="truncate">{ins.articulo}</span>
                      </div>
...
// Emoji distintivo: insumo (materia prima) vs subreceta (preparacion base).
function tipoIcono(t?: string): string {
  return t === 'subreceta' ? '\uD83E\uDD63' : '\uD83D\uDCE6';
}
